// Generated by the Supabase CLI (supabase gen types typescript --local) for project
// slkxwpiiludisrnwnxlg. Do NOT hand-edit — regenerate when the schema changes.
// See apps/web/supabase/README.md.
// (This revision generated from the local stack — schema includes 20260613130000_notification.)
export type Json =
  | string
  | number
  | boolean
...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      notification_type: "turnover_ready"
